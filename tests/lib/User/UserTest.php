...
class UserTest extends TestCase {
	...
	public function testSetPassword() {
		...
		$calledEvent = [];
		\OC::$server->getEventDispatcher()->addListener('\OC\User\User::post_setPassword', function ($event) use (&$calledEvent) {
			$calledEvent[] = '\OC\User\User::post_setPassword';
		...
		$this->assertEquals('\OC\User\User::post_setPassword', $calledEvent[0]);
